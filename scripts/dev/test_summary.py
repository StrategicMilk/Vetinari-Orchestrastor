...
Usage::
    ...
    python.cmd scripts/dev/run_tests.py      # writes .vetinari/test-results.xml
    python.cmd scripts/dev/test_summary.py   # reads it and prints summary
...
def main() -> int:
    ...
    if not RESULTS_PATH.exists():
        ...
        print("Run: python.cmd scripts/dev/run_tests.py")
