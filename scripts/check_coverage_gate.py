...
def main() -> int:
    ...
    parser.add_argument("--report",     default="coverage.json",
                        help="Path to pytest coverage JSON report")
    parser.add_argument("--fail-under", type=float, default=GLOBAL_MIN,
                        dest="fail_under",
                        help="Global minimum coverage percent")
    ...
    print(f"\n  PASS: All {len(report.get('files', {}))} modules meet coverage thresholds.")
    return 0
