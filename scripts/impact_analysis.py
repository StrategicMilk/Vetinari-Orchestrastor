...
Usage:
    python scripts/impact_analysis.py FILE [--depth N] [--reverse] [--output FILE]
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python scripts/impact_analysis.py vetinari/types.py\n"
            "  python scripts/impact_analysis.py vetinari/types.py --depth 2\n"
            "  python scripts/impact_analysis.py vetinari/types.py --reverse\n"
            "  python scripts/impact_analysis.py vetinari/agents/contracts.py --depth 1 --output impact.txt"
        ),
    )
    parser.add_argument(
        "file",
