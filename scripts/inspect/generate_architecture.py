...
Usage:
    python scripts/inspect/generate_architecture.py [--output FILE] [--format FORMAT]
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python scripts/inspect/generate_architecture.py\n"
            "  python scripts/inspect/generate_architecture.py --format dot --output graph.dot\n"
            "  python scripts/inspect/generate_architecture.py --format text"
        ),
    )
    parser.add_argument(
        "--output",
