...
Usage:
    python scripts/maintenance/verify_wiring.py
    python scripts/maintenance/verify_wiring.py --verbose
"""
...
if __name__ == "__main__":
    ...
    if _unknown:
        print("Usage: python scripts/maintenance/verify_wiring.py [--verbose|-v]")
