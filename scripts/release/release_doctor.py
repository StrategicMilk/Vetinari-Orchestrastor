...
Usage::
    ...
    python scripts/release/release_doctor.py --version 0.9.0
    python scripts/release/release_doctor.py --version dev --quiet
...
def main(argv: list[str] | None = None) -> int:
    """Entry point for ``python scripts/release/release_doctor.py``.
