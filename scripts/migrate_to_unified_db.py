...
Usage:
    python scripts/migrate_to_unified_db.py              # Full migration
    python scripts/migrate_to_unified_db.py --dry-run    # Preview only
    python scripts/migrate_to_unified_db.py --backup     # Backup before migrate
