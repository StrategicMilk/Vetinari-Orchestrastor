...
class CorrelationContext:
    ...
    def __init__(self, trace_id: str | None = None, span_id: str | None = None, request_id: str | None = None):
...
class StructuredFormatter(logging.Formatter):
    ...
    def __init__(self, include_extra: bool = True, include_context: bool = True):
        ...
        self._context = {"service": "vetinari", "version": os.environ.get("VETINARI_VERSION", "unknown")}
...
def log_event(level: str, logger_name: str, message: str, **context):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            with CorrelationContext(trace_id=trace_id):
                ...
                try:
                    logger.info(
                        f"Operation started: {operation_name}", event_type="operation_start", operation=operation_name
                    )
