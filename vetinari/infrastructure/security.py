...
from being persisted in memory backends.
...
class SecretScanner:
    ...
    def __init__(self, additional_patterns: Optional[List[SecretPattern]] = None):
    ...
    def sanitize_object(self, obj: Any, placeholder: str = "[REDACTED]") -> Any:
        ...
        if isinstance(obj, str):
            ...
            return [
                self.sanitize_object(item, placeholder)
                for item in obj
            ]
