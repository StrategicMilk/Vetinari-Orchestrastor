    ...
    def _wire_skills_to_registry(self) -> None:
        ...
        try:
            ...
            skill_modules = [
                ...
                "vetinari.tools.devops_skill",
                "vetinari.tools.version_control_skill",
                "vetinari.tools.error_recovery_skill",
                "vetinari.tools.context_manager_skill",
                "vetinari.tools.image_generator_skill",
                "vetinari.tools.user_interaction_skill",
                "vetinari.tools.improvement_skill",
