...
class PlanningEngine:
    def __init__(self, default_models: List[str] = None, fallback_models: List[str] = None, 
                 uncensored_fallback_models: List[str] = None, memory_budget_gb: int = 48):
        ...
        self.prompt_type_keywords = {
            ...
            "coding": ["code", "implement", "build", "create", "program", "script", "function", "class", "api", "software", "agent", "app", "web", "python", "javascript"],
            ...
            "financial": ["stock", "investment", "trading", "financial", "money", "profit", "crypto", "market", "economy"],
        ...
        self.policy_sensitive_keywords = [
            "investment", "stock", "trading", "financial", "money", "profit",
            "hack", "exploit", "weapon", "illegal", "harmful", "adult"
        ]
        
        self.capability_keywords = {
            "code_gen": ["code", "implement", "build", "create", "python", "javascript", "script", "api", "web", "function", "class", "program", "software", "agent", "generate"],
    ...
    def plan(self, goal: str, system_prompt: str, models: List[Dict], planning_model: str = None) -> Plan:
        ...
        if not available_models:
            plan.warnings.append(f"No models fit within memory budget of {self.memory_budget_gb}GB. Using smallest available.")
    ...
    def _generate_tasks_from_goal(self, goal: str, parent_id: str = "", depth: int = 0, max_depth: int = 25) -> List[Task]:
        ...
        is_code_heavy = any(kw in goal_lower for kw in ["code", "implement", "build", "create", "program", "agent", "script", "app", "web", "software"])
        is_planning = any(kw in goal_lower for kw in ["plan", "strategy", "design", "workflow", "analyze"])
        is_docs = any(kw in goal_lower for kw in ["document", "readme", "explain", "docs", "write"])
        ...
        if depth == 0:
            ...
            subtasks = [
                ("Gather background information and existing solutions", ["goal"], ["background_docs", "existing_solutions"]),
                ("Analyze competitors and alternatives", ["background_docs"], ["competitor_analysis", "comparison_report"]),
            ...
            subtasks = [
                ...
                ("Verify compliance with requirements", ["previous_output", "requirements_spec"], ["compliance_report"]),
            ]
    ...
    def _select_best_model(self, scores: List[Dict], preferred_capabilities: List[str] = None) -> str:
    ...
    def _infer_required_capabilities(self, text: str) -> List[str]:
        ...
        if any(kw in text for kw in ["implement", "build", "create", "code"]):
            if "code_gen" not in required:
