...
POLICY_SENSITIVE_KEYWORDS = [
    "harmful", "illegal", "attack", "exploit", "weapon", "bypass",
    " jailbreak", "darkweb", "malware", "phishing", "fraud", "scam",
...
def _get_fallback_models() -> List[Dict]:
    return [
        {"id": "qwen2.5-coder-14b-instruct", "context_length": 32768, "quantization": "q4_k_m", "tags": ["code", "reasoning"]},
        {"id": "qwen2.5-14b-instruct", "context_length": 32768, "quantization": "q4_k_m", "tags": ["general", "reasoning"]},
    ...
    for subtask in all_subtasks:
        try:
            ...
            subtask_tree.update_subtask(plan_id, subtask.subtask_id, {
                "ponder_ranking": ranking_data,
                "ponder_scores": scores,
                "ponder_used": True
            })
