...
from vetinari.explain_agent import get_explain_agent, is_explainability_enabled
...
class PlanModeEngine:
    ...
    def _generate_candidates(
        self, goal: str, constraints: str, domain: TaskDomain, max_candidates: int, depth_cap: int
    ) -> list[PlanCandidate]:
    ...
    def _parse_llm_candidates(
        self, content: str, goal: str, domain: TaskDomain, depth_cap: int, templates: list, max_candidates: int
    ) -> list[PlanCandidate]:
    ...
    def _generate_fallback_candidates(
        self, goal: str, domain: TaskDomain, templates: list, max_candidates: int, depth_cap: int
    ) -> list[PlanCandidate]:
    ...
    def log_approval_decision(
        ...
        try:
            ...
            from vetinari.memory import ApprovalDetails, MemoryEntry, MemoryEntryType
