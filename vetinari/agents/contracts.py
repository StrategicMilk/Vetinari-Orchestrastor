...
from vetinari.types import AgentType, TaskStatus  # canonical source
...
class VerificationResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {"passed": self.passed, "issues": self.issues, "suggestions": self.suggestions, "score": self.score}
...
AGENT_REGISTRY: dict[AgentType, AgentSpec] = {
    ...
    AgentType.EXPLORER: AgentSpec(
        ...
        enabled=False,
        deprecated=True,
        replaced_by="CONSOLIDATED_RESEARCHER",
    ),
    ...
    AgentType.ORACLE: AgentSpec(
        ...
        enabled=False,
        deprecated=True,
        replaced_by="CONSOLIDATED_ORACLE",
    ),
    AgentType.RESEARCHER: AgentSpec(
        agent_type=AgentType.RESEARCHER,
        name="Researcher (legacy)",
