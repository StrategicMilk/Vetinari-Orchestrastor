...
class ADRSystem:
    ...
    def create_adr(self, title: str, category: str, context: str, decision: str,
                   consequences: str = "", created_by: str = "user") -> ADR:
    ...
    def list_adrs(self, status: str = None, category: str = None, limit: int = 50) -> List[ADR]:
    ...
    def update_adr(self, adr_id: str, updates: dict) -> Optional[ADR]:
    ...
    def deprecate_adr(self, adr_id: str, replacement_id: str = None) -> Optional[ADR]:
        adr = self.adrs.get(adr_id)
        if not adr:
            return None
