...
class SubtaskTree:
    ...
    def create_subtask(self, plan_id: str, parent_id: str, depth: int, description: str,
                       prompt: str, agent_type: str, max_depth: int = 14,
                       dod_level: str = "Standard", dor_level: str = "Standard",
                       estimated_effort: float = 1.0, max_depth_override: int = 0,
                       inputs: List[str] = None, outputs: List[str] = None,
                       decomposition_seed: str = "") -> Subtask:
