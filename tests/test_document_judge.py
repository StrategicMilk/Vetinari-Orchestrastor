...
from vetinari.validation.document_quality import QualityReport
...
class TestDocumentJudge:
    ...
    def test_evaluate_with_doc_type_enum(self):
        from vetinari.validation.document_types import DocumentType
...
class TestDocumentJudgeLLMPath:
    ...
    def test_merge_scores(self):
        from vetinari.validation.document_quality import DimensionScore, evaluate_document

        judge = DocumentJudge()
        text = "# Test\n\nA document for merge testing."
        report = evaluate_document(text)

        from vetinari.validation.document_types import get_profile_for_type
        ...
        accuracy_ds = next(
            ds for ds in merged.dimension_scores if ds.dimension == "accuracy"
        )
