...
class TestCodeAgentEngine:
    ...
    def test_task_status_tracking(self):
        ...
        from vetinari.coding_agent import CodeAgentEngine, CodeTask, CodingTaskStatus, CodingTaskType
...
class TestCodeBridge:
    ...
    def test_bridge_disabled_returns_error(self):
        ...
        from vetinari.coding_agent.bridge import BridgeTaskSpec, CodeBridge
