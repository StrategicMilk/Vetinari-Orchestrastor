...
from vetinari.memory.interfaces import (
    MemoryEntry, MemoryEntryType, MemoryStats, content_hash,
)
...
class TestMemoryEntryExtended(unittest.TestCase):
    ...
    def test_default_id_format(self):
        e = MemoryEntry()
        self.assertTrue(e.id.startswith("mem_"))
    ...
    def test_to_dict_has_all_fields(self):
        ...
        for k in ("id", "agent", "content", "entry_type", "timestamp"):
            self.assertIn(k, d)
        self.assertEqual(d["entry_type"], "discovery")
    ...
    def test_from_dict_roundtrip(self):
        ...
        self.assertEqual(e2.agent, "explorer")
        self.assertEqual(e2.entry_type, MemoryEntryType.DECISION)

    def test_metadata_field(self):
        e = MemoryEntry(metadata={"plan_id": "p1", "risk": 0.3})
        self.assertEqual(e.metadata["plan_id"], "p1")
    ...
    def test_config_entry_type(self):
        ...
        self.assertEqual(e.entry_type, MemoryEntryType.CONFIG)
...
class TestMemoryStats(unittest.TestCase):
    ...
    def test_defaults(self):
        ...
        self.assertEqual(s.file_size_bytes, 0)
...
class TestOcMemoryStore(unittest.TestCase):
    ...
    def test_remember_and_get(self):
        ...
        self.assertEqual(retrieved.content, "some content")
    ...
    def test_export(self):
        ...
        self.assertTrue("memories" in data or "entries" in data)
...
class TestMnemosyneMemoryStore(unittest.TestCase):
    ...
    def test_remember_and_retrieve(self):
        ...
        self.assertIsNotNone(retrieved)
        self.assertEqual(retrieved.content, "knowledge")
