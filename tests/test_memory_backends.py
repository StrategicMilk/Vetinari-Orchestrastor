...
class TestOcMemoryStore:
    ...
    def test_store_and_retrieve(self, temp_path):
        ...
        from vetinari.memory import OcMemoryStore, MemoryEntry, MemoryEntryType
...
class TestMnemosyneMemoryStore:
    ...
    def test_store_and_retrieve(self, temp_path):
        """Test basic store and retrieve operations."""
        from vetinari.memory import MnemosyneMemoryStore, MemoryEntry, MemoryEntryType
...
class TestMemoryMergePolicy:
    ...
    def test_timestamp_precedence(self, temp_paths):
        ...
        assert len(results) == 1
        assert "oc" in results[0].source_backends and "mnemosyne" in results[0].source_backends
