...
class TestEnums:
    ...
    def test_subtask_status_values(self):
        ...
        assert StatusEnum.COMPLETED in list(StatusEnum)
...
class TestSubtask:
    ...
    def test_custom_fields(self):
        s = Subtask(description="Build feature", domain=TaskDomain.CODING, depth=2, status=StatusEnum.IN_PROGRESS)
...
class TestPlanCandidate:
    def test_auto_plan_id(self):
        ...
        assert pc.risk_score == pytest.approx(0.3)
    ...
    def test_from_dict(self):
        ...
        assert pc2.risk_score == pytest.approx(0.2)
