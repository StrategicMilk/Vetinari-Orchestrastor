...
def _engine():
    ...
    e.configure(
        AnomalyConfig(
            window_size=20, z_threshold=2.5, iqr_factor=1.5, ewma_alpha=0.3, ewma_threshold=2.5, min_samples=5
        )
    )
    return e
...
class TestIQRDetection:
    ...
    def test_value_within_iqr_fence_not_flagged(self):
        e = _engine()
        for v in [90, 95, 100, 105, 110, 90, 95, 100, 105, 110, 90, 95, 100, 105, 110]:
