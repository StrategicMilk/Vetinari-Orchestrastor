...
class TestPonderEngine:
    ...
    def test_task_capability_requirements_policy_sensitive(self):
        ...
        assert reqs["policy_sensitive"] == True
...
class TestCloudProviders:
    ...
    def test_cloud_provider_health_no_tokens(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            assert health["huggingface_inference"]["has_token"] == False
            assert health["claude"]["has_token"] == False
            assert health["gemini"]["has_token"] == False
    ...
    def test_cloud_provider_health_with_tokens(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert health["huggingface_inference"]["has_token"] == True
            assert health["claude"]["has_token"] == True
            assert health["gemini"]["has_token"] == True
...
class TestSubtaskTreePonder:
    ...
    def test_subtask_has_ponder_fields(self):
        ...
        assert subtask.ponder_used == False
    ...
    def test_subtask_from_dict_includes_ponder(self):
        ...
        assert subtask.ponder_used == True
